...
public class CSVParserFactory {
	 ...
	 * @throws IOException
	 *             - If the file can't be opened or is missing
	 */
	 ...
	 * will try to find the delimiter used in the file, as long as it is one of
	 * the following: ';' ',' ':' or tab
	 * 
	 * @param csv
	 *            file
	 * @return CSVParser object
	...
	/**
	 * Creates a a new CSVParser object based on the file you provide, this
	 * method will try to find the delimiter, it will also try to find errors in
	 * the CSV file. If it finds no errors it closes the parser.
	 * 
	 * @param csv
	 *            file
	 * @throws InvalidAttributesException
	 *             - Gets thrown if the file contains an error, the message will
	 *             say which line of the file contains the error
	 * @throws IOException
	 *             - If the file can't be opened or is missing
	 */
