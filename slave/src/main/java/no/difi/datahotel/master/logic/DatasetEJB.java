...
import static no.difi.datahotel.util.shared.Filesystem.FILE_DATASET_ORIGINAL;
import static no.difi.datahotel.util.shared.Filesystem.FILE_VERSION;
import static no.difi.datahotel.util.shared.Filesystem.FOLDER_MASTER;
