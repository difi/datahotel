...
import no.difi.datahotel.util.model.Abstract;
...
public class AbstractTest {
	...
	public class AbstractClass extends Abstract {
		public void save() throws Exception {
			super.save(Filesystem.getFile("bridge", "failSave.xml"), null);
		}

		public AbstractClass read() {
			return (AbstractClass) read(AbstractClass.class, Filesystem.getFile("brigde", "failRead.xml"));
		}
	}
